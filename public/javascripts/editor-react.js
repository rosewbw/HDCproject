...
/***/ function(module, exports, __webpack_require__) {
	...
	var butnControl = __webpack_require__(159);
	var saveButnInfoFunction = __webpack_require__(160);
	var optionsControl = __webpack_require__(161);
	var canvas = __webpack_require__(162);
	var upImg = __webpack_require__(163);
	var upVideo = __webpack_require__(164);
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'div',
						{ id: 'pre-content' },
						React.createElement('iframe', { src: url, frameBorder: '0', scrolling: 'no', height: '405px', width: '720px' })
					)
				)
			);
		}
	...
	var EditorVideoPlace = React.createClass({
		displayName: 'EditorVideoPlace',

		render: function () {
			return React.createElement(
				'div',
				{ id: 'editor-video-area' },
				React.createElement('video', { id: 'editor-video', src: this.props.videoUrl, controls: 'controls' }),
				React.createElement('div', { id: 'editor-butn-layer' })
			);
		}
	});

	var EditorMainController = React.createClass({
		displayName: 'EditorMainController',

		render: function () {
			return React.createElement('div', { id: 'editor-main-controller' });
		}
	});

	var EditorButnOptionsController = React.createClass({
		displayName: 'EditorButnOptionsController',
		...
		render: function () {
			return React.createElement(
				'div',
				{ id: 'editor-butn-options-controller' },
				React.createElement(EditorOptionsTitle, { style: this.state.style, changeTitle: this.changeTitle }),
				React.createElement(EditorBasicOptions, { style: this.state.style }),
				React.createElement(EditorExpandOptions, { style: this.state.style }),
				React.createElement(EditorSeniorOptions, { style: this.state.style })
			);
		}
	});

	var EditorOptionsTitle = React.createClass({
		displayName: 'EditorOptionsTitle',

		render: function () {
			return React.createElement(
				'div',
				{ id: 'editor-butn-options-title', onClick: this.props.changeTitle },
				React.createElement(
					'div',
					{ id: 'title-basic', className: 'butn-options-title', style: this.props.style['title-basic'] },
					'Basic'
				),
				React.createElement(
					'div',
					{ id: 'title-expand', className: 'butn-options-title', style: this.props.style['title-expand'] },
					'Expand'
				),
				React.createElement(
					'div',
					{ id: 'title-senior', className: 'butn-options-title', style: this.props.style['title-senior'] },
					'Senior'
				),
	...
	var EditorBasicOptions = React.createClass({
		displayName: 'EditorBasicOptions',

		render: function () {
			return React.createElement(
				'div',
				{ id: 'editor-basic-options', style: this.props.style['basic-options'] },
				React.createElement(Bar_options, { name: 'Opacity', unit: '%', max: '100' }),
				React.createElement(Bar_options, { name: 'Radius', unit: 'px', max: '100' }),
				React.createElement(Bar_options, { name: 'Font-Size', unit: 'px', max: '100' }),
				React.createElement(Bar_options, { name: 'Border-Width', unit: 'px', max: '30' }),
				React.createElement(Color_options, null),
				React.createElement(Back_image_options, null)
			);
		}
	});

	var EditorExpandOptions = React.createClass({
		displayName: 'EditorExpandOptions',

		render: function () {
			return React.createElement('div', { id: 'editor-expand-options', style: this.props.style['expand-options'] });
		}
	});

	var EditorSeniorOptions = React.createClass({
		displayName: 'EditorSeniorOptions',

		render: function () {
			return React.createElement('div', { id: 'editor-senior-options', style: this.props.style['senior-options'] });
		}
	});

	var Bar_options = React.createClass({
		displayName: 'Bar_options',
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement('div', { id: this.props.name, className: 'option-bar-slider', max: this.props.max })
							),
							React.createElement('input', { name: this.props.name, type: 'text' }),
							React.createElement(
								'span',
								null,
								this.props.unit
	...
	var Back_image_options = React.createClass({
		displayName: 'Back_image_options',

		render: function () {
			return React.createElement(
				'div',
				{ className: 'options-container', style: { 'height': '110px' } },
				React.createElement(
					'dl',
					{ style: { 'height': '105px' } },
					React.createElement(
					...
					React.createElement(
						'dd',
						null,
						React.createElement('div', { id: 'upload-img-view' }),
						React.createElement(
							'div',
							{ id: 'image-up-form-container' },
							'Pick Image',
							React.createElement(
								'form',
								{ id: 'image-form', name: 'upload-image-form', method: 'post', encType: 'multipart/form-data' },
								React.createElement('input', { id: 'image-uploader', name: 'imageup', type: 'file' })
							)
						),
						React.createElement('div', { className: 'clear-float' })
					)
	...
	var Color_options = React.createClass({
		displayName: 'Color_options',

		render: function () {
			return React.createElement(
				'div',
				{ className: 'options-container', style: { 'height': '120px' } },
				React.createElement(
					'dl',
					{ style: { 'height': '115px' } },
					React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'form',
							{ id: 'color-options-form' },
							React.createElement('input', { type: 'radio', id: 'color-option-button', name: 'color-option' }),
							React.createElement(
								'label',
								{ htmlFor: 'color-option-button' },
								'Background'
							),
							React.createElement('input', { type: 'radio', id: 'color-option-font', name: 'color-option' }),
							React.createElement(
								'label',
								{ htmlFor: 'color-option-font' },
								'Font'
							),
							React.createElement('input', { type: 'radio', id: 'color-option-border', name: 'color-option' }),
							React.createElement(
								'label',
								{ htmlFor: 'color-option-border' },
								'Border'
							)
						)
					),
					React.createElement(
						'dd',
						null,
						React.createElement('div', { id: 'option-black', className: 'color-block' }),
						React.createElement('div', { id: 'option-white', className: 'color-block' }),
						React.createElement('div', { id: 'option-red', className: 'color-block' }),
						React.createElement('div', { id: 'option-green', className: 'color-block' }),
						React.createElement('div', { id: 'option-blue', className: 'color-block' }),
						React.createElement('div', { id: 'option-yellow', className: 'color-block' }),
						React.createElement('div', { id: 'option-purple', className: 'color-block' }),
						React.createElement('div', { id: 'option-orange', className: 'color-block' }),
						React.createElement('div', { className: 'clear-float' })
					)
				)
			);
	...
	var EditorSaveAndCancle = React.createClass({
		displayName: 'EditorSaveAndCancle',

		render: function () {
			return React.createElement(
				'div',
				{ id: 'editor-save-and-cancel' },
				React.createElement(
					'div',
					{ id: 'editor-save', onClick: this.props.save },
					'Save'
				),
				React.createElement(
					'div',
					{ id: 'editor-cancel', onClick: this.props.close },
					'Cancel'
				),
				React.createElement(
					'div',
					{ id: 'upload-progress-container' },
					React.createElement('p', { id: 'upload-file-name' }),
					React.createElement(
						'div',
						{ id: 'upload-progress-bar' },
						React.createElement('div', { id: 'upload-progress' })
					)
				)
			);
		}
	...
	var EditorContainer = React.createClass({
		...
		render: function () {
			return React.createElement(
				'div',
				{ id: 'button-editor' },
				React.createElement(EditorHeader, { close: this.cancelEditor }),
				React.createElement(
					'div',
					{ id: 'editor-left-content-container' },
					React.createElement(EditorVideoPlace, { videoUrl: this.props.editorInfo.videoUrl }),
					React.createElement(EditorMainController, null),
					React.createElement(EditorSaveAndCancle, { close: this.cancelEditor, save: this.saveEditor })
				),
				React.createElement(EditorButnOptionsController, null)
			);
		}
	});

	var ButtonEditor = React.createClass({
		displayName: 'ButtonEditor',
		...
		render: function () {
			return React.createElement(
				'div',
				{ id: 'container' },
				React.createElement(EditorContainer, { editorInfo: this.state.editorInfo })
			);
		}
	});
	...
	var Media = React.createClass({
		...
		render: function () {
			return React.createElement(
				'div',
				{ className: 'imgbox' },
				React.createElement('img', { src: this.props.media.imgUrl }),
				React.createElement(
					'span',
					{ className: 'video-url-span' },
					this.props.media.videoUrl
				)
			);
		}
	});
	...
	var MediaListContent = React.createClass({
		...
		render: function () {
			var mediaNodes = this.props.medias.map(function (media) {
				...
				return React.createElement(Media, { media: media });
			});
			return React.createElement(
				'div',
				{ id: 'mediaList_content' },
				mediaNodes,
				React.createElement('div', { className: 'clear-float' })
			);
		}
	...
	var MediaListNav = React.createClass({
		displayName: 'MediaListNav',

		render: function () {
			return React.createElement('div', { id: 'mediaList_nav' });
		}
	});

	var MediaListFooter = React.createClass({
		displayName: 'MediaListFooter',
		...
		render: function () {
			return React.createElement(
				...
				React.createElement(
					'div',
					{ id: 'video-uploader-container' },
					'Upload',
					React.createElement(
						'form',
						{ id: 'video-form', name: 'upload-video-form', method: 'post', encType: 'multipart/form-data' },
						React.createElement('input', { id: 'video-uploader', name: 'videoup', type: 'file' })
					)
				),
				React.createElement('div', { id: 'progress-container' })
			);
		}
	});

	var MainMediaList = React.createClass({
		displayName: 'MainMediaList',

		startPreview: function () {
			ReactDOM.render(React.createElement(Preview, null), document.getElementById('react-insert-point-preview'));
		},
		buttonEdit: function (e) {
			var elmId = $('.chosen').attr('id');
			ReactDOM.render(React.createElement(ButtonEditor, { elmId: elmId }), document.getElementById('react-insert-point-preview'));
		},
		render: function () {
			return React.createElement(
				'div',
				...
				React.createElement(
					'div',
					{ id: 'start-butn-editor', onClick: this.buttonEdit },
					'Edit'
				),
				React.createElement(
					'div',
					{ id: 'start-preview', onClick: this.startPreview },
					'Preview'
				),
				React.createElement(MediaListNav, null),
				React.createElement(MediaListContent, { medias: this.props.medias }),
				React.createElement(MediaListFooter, { uploadChange: this.props.uploadChange })
			);
		}
	});
	...
	var MainCanvas = React.createClass({
		...
		render: function () {
			return React.createElement('div', { id: 'main_canvas' });
		}
	});

	var StoryMain = React.createClass({
		displayName: 'StoryMain',
		...
		render: function () {
			return React.createElement(
				'div',
				{ id: 'story_main' },
				React.createElement(MainCanvas, { canvas: this.state.canvas }),
				React.createElement(MainMediaList, { medias: this.state.medias, uploadChange: this.uploadChange })
			);
		}
	});

	ReactDOM.render(React.createElement(StoryMain, { initurl: '/api/getmedias', saveinfourl: '/api/saveElementInfo' }), document.getElementById('react-insert-point-canvas'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function ($) {
		...
		function setButnCss(butn, input, info) {
			...
			}).attr('id', info.targetId + '_').addClass('editor-button');
			input.css({
				'width': '80%',
				'border-style': 'none',
		...
		function layoutZoomFrame(frame, obj) {
			...
			frame.append(nwSquare, neSquare, seSquare, swSquare).addClass(obj.frameClass);
			return frame;
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function ($) {
	    ...
	    function get_img_size() {
	        return [ctrl.list.children('.' + basic_options.imgBoxClass).innerWidth() / 2, ctrl.list.children('.' + basic_options.imgBoxClass).innerHeight() / 2];
	    }
	    ...
	    function set_floatImg_css(e, floatImg, fun, _this) {
	        ...
	        var imgSize = get_img_size();
	        floatImg.addClass('canvas-api-floatImg').css({
	            'width': imgSize[0] * 2,
	            'height': imgSize[1] * 2,
	    ...
	    function layout_title(fun) {
	        ...
	        input.attr({
	            'type': 'text',
	            'value': 'Node ' + node
	        }).addClass('canvas-api-img-title no-border-input').css('width', imgSize[0] * 2);
	        return input;
	    }
	    ...
	    function makePath(deltaX, deltaY, path, arrow) {
	        var ax = basic_options.arrowHeight,
	            ay = basic_options.arrowBottom;
	        if (deltaX > 42) {
