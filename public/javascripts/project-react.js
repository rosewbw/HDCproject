...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProCreateTime = React.createClass({
		displayName: 'ProCreateTime',

		render: function () {
			return React.createElement(
				'div',
				{ className: 'pro-create-time-box' },
				React.createElement(
					'p',
					null,
					this.props.time
	...
	var ProAddInfo = React.createClass({
		...
		render: function () {
			return React.createElement(
				...
				React.createElement(
					'form',
					{ className: 'new-pro-info-form', onSubmit: this.handleSubimt },
					React.createElement(
						'div',
						{ className: 'new-pro-info-input' },
						React.createElement(
							'span',
							{ className: 'pro-input-title' },
							'project-name'
						),
						React.createElement('input', { type: 'text', ref: 'proName' })
					),
					React.createElement(
						'div',
						{ className: 'new-pro-info-submit' },
						React.createElement('input', { className: 'submit', type: 'submit', value: 'Submit' }),
						React.createElement(
							'div',
							{ className: 'cancle', onClick: this.proAddBoxCancle },
							'Cancle'
						)
					)
				)
		...
		render: function () {
			...
			return React.createElement(
				...
				React.createElement(
					'a',
					{ href: ahref },
					React.createElement(ProImg, { img: this.props.proInfo.img })
				),
				React.createElement(ProName, { name: this.props.proInfo.proName }),
				React.createElement(ProCreateTime, { time: this.props.proInfo.createTime }),
				React.createElement(
					'div',
					{ className: 'pro-remove', onClick: this.clickProRemove },
					'×'
				)
			);
		}
	...
	var ProjectList = React.createClass({
		...
		render: function () {
			...
			var projectNodes = this.state.data.map(function (pro) {
				...
				return React.createElement(ProjectBox, { proInfo: pro, projectRemove: remove });
			});
			if (!this.state.addition) {
				return React.createElement(
					...
					projectNodes,
					React.createElement('div', { className: 'pro-add-box', onClick: this.projectAdditionBox }),
				...
				return React.createElement(
					...
					{ className: 'pro-container' },
					projectNodes,
					React.createElement('div', { className: 'pro-add-box' }),
					React.createElement('div', { className: 'clear-float' }),
					React.createElement(ProAddInfo, { onSubmitHandle: this.handleProjectAdditionSubimt, onClickHandle: this.addBoxCancle })
				);
			}
		}
	});
	...
	var ProContainer = React.createClass({
		displayName: 'ProContainer',

		render: function () {
			return React.createElement(ProjectList, { urlGet: this.props.urlGet, urlPut: this.props.urlPut, urlRemove: this.props.urlRemove });
		}
	});

	ReactDOM.render(React.createElement(ProContainer, { urlGet: '/projects', urlPut: '/projectsAddition', urlRemove: '/api/projectRemove' }), document.getElementById('react-insert-point-pro'));
